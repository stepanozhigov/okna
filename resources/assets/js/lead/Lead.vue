      ...
      <div class="lheader__wrapper">
        <div class="lheader__items">
          <div class="lheader__items_item">
            ...
            <p class="lheader__name">Фабрика окон</p>
          </div>
        ...
        <div class="lcontent__items">
          <div class="lcontent__items_item">
            ...
            <h1 class="lcontent_title">
              <span class="header">Пластиковые окна</span><br>
              <span class="location" v-html="name_formatted"></span> от <span class="animate_number"><i>7</i>&nbsp;<i>8</i><i>0</i><i>0</i></span> <span class="rouble">8</span>
            </h1>
            <p class="lcontent_subtitle">
                Оставьте ваш номер телефона для расчёта окна или балкона по WhatsApp и получите купон на сумму 5000 <span class="rouble">8</span> в подарок!
            </p>
        ...
        <div class="modal__container" v-if="!$store.state.isSuccess">
          ...
          <div class="modal__lcontent">
            ...
            <span class="modal_linkClose" @click="toogleModal">Закрыть</span>
              <div style="flex-grow: 1;"></div>
              <div class="modal_copyright">Оставляя контактную информацию, вы соглашаетесь на <span>обработку персональных данных</span></div>
          </div>
        </div>
