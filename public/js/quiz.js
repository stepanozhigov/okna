...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('quiz-component', __webpack_require__(8));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4310f1a4", Component.options)
  } else {
    hotAPI.reload("data-v-4310f1a4", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_masked_input__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_slider_component__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue2_touch_events__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue2_touch_events___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue2_touch_events__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_cookie__ = __webpack_require__(42);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_3_vue2_touch_events___default.a);
var pattern = /^[0-9]+$/;
	...
	data: function data() {
		return {
			...
			gifts: [{
				...
				img: "/img/quiz_windows/gifts/gift-2.jpg"
			}, {
				title: "Купон 5000 руб",
				img: "/img/quiz_windows/gifts/gift-1.jpg"
			}, {
				title: "Москитная сетка",
				img: "/img/quiz_windows/gifts/gift-3.jpg"
			}]
		};
	},
	computed: {
	...
	methods: {
		...
		submitQuiz: function submitQuiz(e) {
			...
			if (this.questions.type === "") {
				this.questions.type = "Другое";
			}
			if (this.questions.when === "") {
				this.questions.when = "Не знаю";
			}

			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post("/forms/quiz", {
				phone: "8" + this.questions.phone,
				city: window.city.bx_code,
				type: this.questions.type,
				when: this.questions.when,
				...
				// 		"https://www.instagram.com/p/B6irm-7oSpB/?igshid=vj3wkl2esfmv";
				// }, 4000);
			});
		},
          ...
          _c("div", { staticClass: "header__items" }, [
            _c("div", { staticClass: "header__items_item logo" }, [
              _c(
                ...
                [
                  _c("img", {
                    attrs: { src: "/img/quiz_windows/logo.svg", alt: "logo" }
                  })
                ]
              ),
              _vm._v(" "),
              _c("p", { staticClass: "logo_name" }, [_vm._v("Фабрика окон")])
            ]),
            _vm._v(" "),
                  ...
                  ? _c(
                      ...
                      [
                        ...
                        _c("div", { staticClass: "quest__list quest__range" }, [
                          _c("div", { staticClass: "quest__range_large" }, [
                            _c("ul", [
                              _c("li", [
                                _c(
                                  "label",
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.questions.type,
                                          expression: "questions.type"
                                        }
                                      ],
                                      staticClass: "hidden",
                                      attrs: {
                ...
                _vm.step == 2
                  ? _c(
                      ...
                      [
                        ...
                        _c("div", { staticClass: "quest__list quest__range" }, [
                          _c("ul", [
                            _c("li", { staticClass: "quest_pad_2x" }, [
                              _c(
                                "label",
                                {
                                  staticClass: "radio",
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.questions.when,
                                        expression: "questions.when"
                                      }
                                    ],
                                    staticClass: "hidden",
                                    attrs: {
          ...
          _c("div", { staticClass: "inf__items" }, [
            _c("div", { staticClass: "inf__items_item" }, [
              ...
              _c("p", { staticClass: "inf_text" }, [
                _vm._v("Выезд мастера бесплатно!")
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "inf__items_item" }, [
              ...
              _vm._v(" "),
              _c("p", { staticClass: "inf_text" }, [_vm._v("Договор на дому")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "inf__items_item" }, [
              _c(
              ...
              _vm._v(" "),
              _c("p", { staticClass: "inf_text" }, [_vm._v("Сертификаты")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "inf__items_item" }, [
              _c(
              ...
              _vm._v(" "),
              _c("p", { staticClass: "inf_text" }, [_vm._v("Гарантия 30 лет")])
            ])
          ])
        ])
      ]),
        ...
        ? _c("modal", { on: { close: _vm.openFormError } }, [
            _c("div", { attrs: { slot: "content" }, slot: "content" }, [
              _c("p", { staticClass: "modal-title" }, [
                _vm._v("Вы уже отправляли заявку!")
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "modal-intro" }, [
                _vm._v("В ближайшее время мы свяжется с вами.")
              ])
            ])
          ])
        : _vm._e()
  ...
  function() {
    ...
    return _c("div", [
      _c("p", { staticClass: "hero_intro" }, [
        _vm._v("Пройдите тест за 30 секунд")
      ]),
      _vm._v(" "),
      _c("h1", { staticClass: "hero_title" }, [
        _vm._v("\n\t\t\t\t\t\t\t\tПолучите расчёт окна или балкона "),
        _c("br"),
        _c("span", { staticClass: "mark" }, [_vm._v("и подарок")])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "quest_img" }, [
      _c("img", { attrs: { src: "/img/quiz_windows/234.jpg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("div", { staticClass: "quest__titles" }, [
      _c("p", { staticClass: "quest_intro" }, [_vm._v("Вопрос 1/3")]),
      _vm._v(" "),
      _c("p", { staticClass: "quest_title" }, [
        _vm._v("Укажите параметры вашего помещения")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest_img" }, [
      _c("img", { attrs: { src: "/img/quiz_windows/121.jpg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest__titles" }, [
      _c("p", { staticClass: "quest_intro" }, [_vm._v("Вопрос 2/3")]),
      _vm._v(" "),
      _c("p", { staticClass: "quest_title" }, [
        _vm._v("Когда планируете делать заказ?")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest_img" }, [
      _c("img", { attrs: { src: "/img/quiz_windows/132.jpg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest__titles" }, [
      _c("p", { staticClass: "quest_intro" }, [_vm._v("Вопрос 3/3")]),
      _vm._v(" "),
      _c("p", { staticClass: "quest_title" }, [
        _vm._v("Выберите подарок к вашему заказу")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest_img" }, [
      _c("img", { attrs: { src: "/img/quiz_windows/130.jpg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "quest__titles" }, [
      _c("p", { staticClass: "quest_intro" }, [_vm._v("Расчет")]),
      _vm._v(" "),
      _c("p", { staticClass: "quest_title" }, [
        _vm._v("Получите расчёт вашего заказа и подарок")
      ])
    ])
  },
  function() {
    ...
    return _c("p", { staticClass: "quest_info" }, [
      _vm._v(
        "\n\t\t\t\t\t\t\tВведите номер телефона и получите расчёт на WhatsApp и СМС в\n\t\t\t\t\t\t\tтечении "
      ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4310f1a4", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4014edf0", Component.options)
  } else {
    hotAPI.reload("data-v-4014edf0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4014edf0", module.exports)
  }
}
